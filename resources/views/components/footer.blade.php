    ...
    <div class="container">
            ...
            <div class="col-lg-4 mb-4">
                <div class="d-flex align-items-center mb-3">
                    <img src="https://www.tanjungpinangkota.go.id/images/lambang_235.png" alt="SIDEKRA Logo" height="40"
                        class="me-2">
                    <img src="https://dekranasda.kepriprov.go.id/resources/config/icon-dkn.png" alt="SIDEKRA Logo"
                        height="40" class="me-2">
                    <span class="h5 mb-0">SIDEKRA</span>
                </div>
                <p class="mb-3">Platform digital untuk mendukung pengembangan Usaha Kecil Menengah (UMKM) dan kerajinan
                    daerah.</p>
                <div class="d-flex">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-md-end">
                <small class="text-white text-opacity-50">Dikelola oleh DEKRENASDA Kota Tanjungpinang</small>
            </div>
        </div>
    </div>
</footer>
